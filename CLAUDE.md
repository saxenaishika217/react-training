...
- **Background Workers**: pattern-consolidator, routing-accuracy-monitor
...
Task({
  ...
  subagent_type: 'qe-test-architect',
  run_in_background: true,
});
Task({
  prompt: 'Find coverage gaps',
...
_Generated by AQE v3 init - 2026-09-09T04:45:42.035Z_
