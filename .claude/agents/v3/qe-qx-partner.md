...
WebFetch({
  url: '${URL}',
  prompt:
    'Extract all text content, navigation structure, forms, and interactive elements',
});
```
...
- aqe/v3/domains/_/quality/_ - All domain quality data
...
<div class="heuristic-item">
  ...
  <div class="recommendation">
    <strong>Recommendation:</strong> [actionable advice]
  </div>
</div>
```
