...
interface RiskWeights {
  ...
  complexity: 0.2; // Cyclomatic and Halstead
  fanOut: 0.2; // Number of dependencies
  defectHistory: 0.15; // Historical defect density
  testCoverage: 0.1; // Inverse of coverage
  age: 0.1; // Time since last major refactor
}
```

---

_This shard is enforced by @claude-flow/guidance governance system._
